...
{
    public class SetStaminaCommand : IConsoleCommand
    {
        public SetStaminaCommand(IConsoleEngine console) => Console = console;
        ...
        public List<string> Execute(int value)
        {
            ...
            {
                Console.Attributes.Stamina = value;
                ...
                return new List<string> { "Stamina value setted to " + value };
            }
