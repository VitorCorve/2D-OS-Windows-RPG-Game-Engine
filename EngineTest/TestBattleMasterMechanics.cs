...
namespace EngineTest
{
    public class TestBattleMasterMechanics
    {
        public TestBattleMasterMechanics()
        {
            ...
            var playerData = dataSerializer.Deserialize($"{workingDirectory}\\Games\\Game of Frameworks\\Saves\\Autosave.json");
            ...
            playerData.PlayerSkills.Skills.Add(lastManStanding);
            playerData.PlayerSkills.Skills.Add(wideBlow);
            playerData.PlayerSkills.Skills.Add(deepDefense);
            playerData.PlayerSkills.Skills.Add(crushLegs);
...
/*
            ...
            var specialAbilitiesObserverService = new SpecialAbilitiesObserverService(battleMaster.PlayerCombatManager.Dealer, playerData.PlayerSkills.Skills);
        ...
        private static void Notification(ACTION_TYPE actionType, string message, SERVICE_OWNER owner, ISkill skill = null)
        {
