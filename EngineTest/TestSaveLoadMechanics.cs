...
namespace EngineTest
{
    public class TestSaveLoadMechanics
    {
        ...
        public void Save()
        {
            ...
            var wearedEquipment = new WearedEquipment(0, 1, 2);
            ...
            playerData.PlayerSkills = playerSkills;
            ...
            var skillLevelUpService = new SkillLevelUpService(playerModelData, playerData.PlayerSkills);
