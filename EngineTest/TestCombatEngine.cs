...
namespace EngineTest
{
    public class TestCombatEngine
    {
        ...
        public void Run(PlayerModelData player1Data, PlayerModelData player2Data, PlayerEntity player1, PlayerEntity player2, ISkill skill1, ISkill skill2, int cyclesCount, double iterationsInterval)
        {
            ...
            var observerService = new ObserverService(player1CombatManager, player1Data, player2Data, SERVICE_OWNER.Player);
            var observerService2 = new ObserverService(player2CombatManager, player2Data, player1Data, SERVICE_OWNER.Enemy);
